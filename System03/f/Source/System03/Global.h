...
private:
	...
	AAgent* agent;	
	UPROPERTY(EditAnywhere, Category = "Propiedades")
	float FieldForceAmount =4.0f;
	UPROPERTY(EditAnywhere, Category = "Propiedades")
	float SeekForceAmount = 100.0f;
	UPROPERTY(EditAnywhere, Category = "Propiedades")
	float FleeForceAmount = 100.0f;
	UPROPERTY(EditAnywhere, Category = "Propiedades")
	float SeparateForceAmount = 2.0f;
	UPROPERTY(EditAnywhere, Category = "Propiedades")
	float AlignForceAmount = 80.0f;
	UPROPERTY(EditAnywhere, Category = "Propiedades")
	float CohesionForceAmount = 80.0f;
