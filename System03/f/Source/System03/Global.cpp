...
void AGlobal::CreateAgents()
{
	...
	FVector InitLocation = FVector(EscenarioSize/2.0f-400.0f, EscenarioSize/2.0f-200.0f, 0.0f);
	FRotator InitRotation = FRotator(0.0f, 0.0f, 0.0f);
	TargetLocation = FVector(EscenarioSize/2.0f+400.0f, EscenarioSize/2.0f-200.0f, 0.0f);
