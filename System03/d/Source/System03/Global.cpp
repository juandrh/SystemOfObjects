...
void AGlobal::CreateAgents()
{
	...
	FVector InitLocation = FVector(EscenarioSize/2-400.0f, EscenarioSize/2-200.0f, 55.0f);
	FRotator InitRotation = FRotator(0.0f, 0.0f, 0.0f);
	TargetLocation = FVector(EscenarioSize/2+400.0f, EscenarioSize/2-200.0f, 55.0f);
